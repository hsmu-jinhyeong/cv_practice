...
img = cv.imread('ch3/soccer.jpg')  # 영상 읽기
...
cv.grabCut(img,mask,None,background,foreground,5,cv.GC_INIT_WITH_MASK) # iterCount=5 반복횟수를 5로 설정, 1로 바꿀 경우 반복횟수가 떨어져서 속도는 빠르지만 정확도는 떨어짐
